...
const Discount = () => {
  const discountEndDate = new Date("2025-08-15T23:59:59");
    ...
    <section className="w-full md:max-w-screen-xl mx-auto mt-24 px-4">
      <div className="flex h-[360px] overflow-hidden rounded-xl shadow-lg">
        ...
        <div className="w-1/2 bg-gray-50 flex flex-col items-center justify-center text-center p-8">
          <h2 className="text-2xl md:text-4xl font-heading font-extrabold text-secondary">Winter Discount</h2>
          <p className="text-lg text-gray-600 text-center mt-2 mb-4">Limited time offer on all products</p>
          ...
          <div className="flex gap-4 text-center mb-6">
            {["days", "hours", "minutes", "seconds"].map((unit) => (
              ...
              >
                ...
                <span className="uppercase text-xs tracking-wide">{unit}</span>
              </div>
            ))}
          </div>
