...
const CallToAction = () => {
  return (
    <section
      className="relative bg-fixed bg-cover bg-center bg-no-repeat mt-0 md:mt-14 py-20 px-5 md:px-16"
      style={{
      ...
      <div className="relative w-full md:max-w-screen-xl mx-auto px-4 z-10 text-center text-white">
        <ZoomIn>
          ...
          <p className="text-lg mb-8">
            Explore daily price trends, analyze your local bazar, and make smart
