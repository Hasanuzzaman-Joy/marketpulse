                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent text-main ${errors.reason ? "border-accent" : "border-border"
                                }`}
                        />
                        {errors.reason && (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className={`w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent text-main resize-none ${errors.feedback ? "border-accent" : "border-border"
                                }`}
                        ></textarea>
                        {errors.feedback && (
                            <p className="text-red-600 text-sm mt-1">{errors.feedback.message}</p>
                        )}
                    </div>
