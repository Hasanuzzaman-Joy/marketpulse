      ...
      <table className="w-full text-left border-collapse border border-border font-body text-main text-sm mb-4">
        <tbody>
          <tr className="border border-border bg-bg">
            ...
            <td className="px-4 py-2 border border-border break-all">{product._id}</td>
          </tr>
          <tr className="border border-border">
            <th className="px-4 py-2 font-heading text-secondary">Vendor Email</th>
            <td className="px-4 py-2 border border-border break-all">{product.vendorEmail}</td>
          </tr>
          <tr className="border border-border bg-bg">
            <th className="px-4 py-2 font-heading text-secondary">Vendor Name</th>
            <td className="px-4 py-2 border border-border">{product.vendorName}</td>
          </tr>
          <tr className="border border-border">
            <th className="px-4 py-2 font-heading text-secondary">Market Name</th>
            <td className="px-4 py-2 border border-border">{product.marketName}</td>
          </tr>
          <tr className="border border-border bg-bg">
            <th className="px-4 py-2 font-heading text-secondary">Date</th>
            <td className="px-4 py-2 border border-border">
              {product.date ? format(new Date(product.date), "d MMMM, yyyy") : "N/A"}
            </td>
          </tr>
          <tr className="border border-border">
            <th className="px-4 py-2 font-heading text-secondary">Market Description</th>
            <td className="px-4 py-2 border border-border">{product.marketDescription}</td>
          </tr>
          <tr className="border border-border bg-bg">
            <th className="px-4 py-2 font-heading text-secondary">Item Name</th>
            <td className="px-4 py-2 border border-border">{product.itemName}</td>
          </tr>
          <tr className="border border-border">
            <th className="px-4 py-2 font-heading text-secondary">Status</th>
            <td className="px-4 py-2 border border-border">
              <span
                className={`px-3 py-1 rounded text-sm font-medium ${product.status === "approved"
          ...
          <tr className="border border-border bg-bg">
            ...
            <td className="px-4 py-2 border border-border">{product.pricePerUnit}</td>
          </tr>
          <tr className="border border-border bg-bg">
          ...
          <tr className="border border-border">
            ...
            <td className="px-4 py-2 border border-border">
              {product.createdAt ? format(new Date(product.createdAt), "d MMMM, yyyy") : "N/A"}
            </td>
          </tr>
        </tbody>
      </table>
