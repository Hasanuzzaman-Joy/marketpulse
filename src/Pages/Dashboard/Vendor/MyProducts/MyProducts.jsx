    ...
    return (
        <div className="p-6 md:p-10 bg-white text-main font-body">
            ...
            {isLoading ? (
                ...
                <Container>
                    <div className="flex flex-col items-center justify-center text-center space-y-3 min-h-[60vh]">
                        ...
                        <p className="text-text-secondary max-w-md text-lg leading-7 mb-6">
