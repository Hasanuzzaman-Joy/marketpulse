...
const AddProduct = () => {
  ...
  return (
    <div className="w-full mx-auto p-6 md:p-10 bg-white rounded shadow-xl text-main font-body">
      <h3 className="text-3xl text-primary font-bold flex items-center gap-2 mb-2">
        <FaPlusSquare /> Add Market Product
      </h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              onClick={() =>
                append({ date: formatDate(new Date()), price: "" })
              }
